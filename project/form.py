...
class RegistrationForm(FlaskForm):
    ...
    def validate_username(self, username):
        ...
        if user:
            raise ValidationError('That username is taken. Please choose differnt one Message')

    def validate_email(self, email):
        email = UserModel.query.filter_by(email=email.data).first()
        if email:
            raise ValidationError('That email is taken. Please choose differnt one Message')
